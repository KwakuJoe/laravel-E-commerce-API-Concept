...
// class AccountCreatedSuccessfullNotification extends Notification
class AccountCreatedSuccessfullNotification extends Notification implements ShouldQueue
{
    use Queueable;
